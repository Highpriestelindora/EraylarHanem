...
-- ALTER TABLE ev_depo for extra metadata columns
ALTER TABLE ev_depo ADD COLUMN IF NOT EXISTS owner TEXT;
ALTER TABLE ev_depo ADD COLUMN IF NOT EXISTS emoji TEXT;
ALTER TABLE ev_depo ADD COLUMN IF NOT EXISTS brand TEXT;
ALTER TABLE ev_depo ADD COLUMN IF NOT EXISTS size TEXT;
ALTER TABLE ev_depo ADD COLUMN IF NOT EXISTS notes TEXT;
