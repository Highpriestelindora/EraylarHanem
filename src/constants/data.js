...
export const PACKING_POOL = [
  // TEMEL (1-20)
  { id: 'p1', text: 'Pasaport', category: 'Temel', icon: '🛂', minDays: 0 },
  { id: 'p2', text: 'Nüfus Cüzdanı / Kimlik', category: 'Temel', icon: '🪪', minDays: 0 },
  { id: 'p3', text: 'Uçak / Tren Biletleri', category: 'Temel', icon: '🎫', minDays: 0 },
  { id: 'p4', text: 'Nakit Para (Döviz/TL)', category: 'Temel', icon: '💵', minDays: 0 },
  { id: 'p5', text: 'Kredi Kartları', category: 'Temel', icon: '💳', minDays: 0 },
  { id: 'p6', text: 'Vize Belgeleri', category: 'Temel', icon: '📄', minDays: 0, type: 'yurtdisi' },
  { id: 'p7', text: 'Otel Rezervasyon Çıktısı', category: 'Temel', icon: '🏨', minDays: 0 },
  { id: 'p8', text: 'Seyahat Sigortası Poliçesi', category: 'Temel', icon: '🛡️', minDays: 0 },
  ...
  // ELEKTRONİK (21-45)
  { id: 'p21', text: 'Akıllı Telefon', category: 'Elektronik', icon: '📱', minDays: 0 },
  { id: 'p22', text: 'Telefon Şarj Cihazı', category: 'Elektronik', icon: '🔌', minDays: 0 },
  { id: 'p23', text: 'Powerbank', category: 'Elektronik', icon: '🔋', minDays: 0 },
  ...
  // GİYİM (46-85)
  { id: 'p46', text: 'İç Çamaşırı (Gün Sayısı +2)', category: 'Giyim', icon: '🩲', minDays: 0 },
  { id: 'p47', text: 'Çorap (Gün Sayısı +2)', category: 'Giyim', icon: '🧦', minDays: 0 },
  { id: 'p48', text: 'Tişört (Kısa Kollu)', category: 'Giyim', icon: '👕', minDays: 0 },
  { id: 'p49', text: 'Tişört (Uzun Kollu)', category: 'Giyim', icon: '👕', minDays: 0 },
  { id: 'p50', text: 'Pantolon (Jean)', category: 'Giyim', icon: '👖', minDays: 0 },
  { id: 'p51', text: 'Pantolon (Kumaş/Şık)', category: 'Giyim', icon: '👖', minDays: 2 },
  { id: 'p52', text: 'Şort', category: 'Giyim', icon: '🩳', minDays: 0, type: 'yaz' },
  ...
  { id: 'p57', text: 'Kazak / Hoodie', category: 'Giyim', icon: '🧥', minDays: 2 },
  { id: 'p58', text: 'Hırka', category: 'Giyim', icon: '🧥', minDays: 2 },
  { id: 'p59', text: 'Mont / Kaban', category: 'Giyim', icon: '🧥', minDays: 0, type: 'kis' },
  { id: 'p60', text: 'Yağmurluk / Rüzgarlık', category: 'Giyim', icon: '🧥', minDays: 0 },
  { id: 'p61', text: 'Pijama Takımı', category: 'Giyim', icon: '🛌', minDays: 1 },
  { id: 'p62', text: 'Yürüyüş Ayakkabısı', category: 'Giyim', icon: '👟', minDays: 0 },
  { id: 'p63', text: 'Şık Ayakkabı', category: 'Giyim', icon: '👞', minDays: 2 },
  { id: 'p64', text: 'Sandalet / Terlik', category: 'Giyim', icon: '🩴', minDays: 0 },
  { id: 'p65', text: 'Deniz Terliği', category: 'Giyim', icon: '🩴', minDays: 0, type: 'yaz' },
  { id: 'p66', text: 'Mayo / Bikini', category: 'Giyim', icon: '🩱', minDays: 0, type: 'yaz' },
  { id: 'p67', text: 'Plaj Havlusu', category: 'Giyim', icon: '🧣', minDays: 0, type: 'yaz' },
  { id: 'p68', text: 'Kemer', category: 'Giyim', icon: 'ベルト', minDays: 0 },
  { id: 'p69', text: 'Atkı / Şal', category: 'Giyim', icon: '🧣', minDays: 0, type: 'kis' },
  { id: 'p70', text: 'Bere / Şapka', category: 'Giyim', icon: '🧢', minDays: 0 },
  { id: 'p71', text: 'Eldiven', category: 'Giyim', icon: '🧤', minDays: 0, type: 'kis' },
  { id: 'p72', text: 'Güneş Gözlüğü', category: 'Giyim', icon: '🕶️', minDays: 0 },
  ...
  { id: 'p82', text: 'Yağmur Botu', category: 'Giyim', icon: '👢', minDays: 0, type: 'kis' },
  { id: 'p83', text: 'Kar Pantolonu', category: 'Giyim', icon: '👖', minDays: 0, type: 'kis' },
  { id: 'p84', text: 'Termal İçlik', category: 'Giyim', icon: '👕', minDays: 0, type: 'kis' },
  { id: 'p85', text: 'Yedek Bağcık', category: 'Giyim', icon: '🧵', minDays: 5 },

  // HİJYEN & BAKIM (86-115)
  { id: 'p86', text: 'Diş Fırçası', category: 'Hijyen', icon: '🪥', minDays: 0 },
  { id: 'p87', text: 'Diş Macunu', category: 'Hijyen', icon: '🦷', minDays: 0 },
  { id: 'p88', text: 'Diş İpi', category: 'Hijyen', icon: '🧵', minDays: 0 },
  { id: 'p89', text: 'Deodorant / Roll-on', category: 'Hijyen', icon: '🧴', minDays: 0 },
  ...
  { id: 'p96', text: 'Güneş Kremi', category: 'Hijyen', icon: '☀️', minDays: 0 },
  { id: 'p97', text: 'Dudak Balmı (SPF)', category: 'Hijyen', icon: '💄', minDays: 0 },
  { id: 'p98', text: 'Tıraş Bıçağı & Köpüğü', category: 'Hijyen', icon: '🪒', minDays: 2 },
  ...
  { id: 'p111', text: 'Güneş Sonrası Losyon', category: 'Hijyen', icon: '🧴', minDays: 0, type: 'yaz' },
  ...
  // SAĞLIK (116-130)
  { id: 'p116', text: 'Düzenli Kullanılan İlaçlar', category: 'Sağlık', icon: '💊', minDays: 0 },
  { id: 'p117', text: 'Ağrı Kesici & Ateş Düşürücü', category: 'Sağlık', icon: '💊', minDays: 0 },
  ...
  { id: 'p121', text: 'Böcek Kovucu Sprey', category: 'Sağlık', icon: '🦟', minDays: 0 },
  { id: 'p122', text: 'Sinek Isırığı Kremi', category: 'Sağlık', icon: '🧴', minDays: 0 },
  ...
  { id: 'p128', text: 'Güneş Yanığı Kremi', category: 'Sağlık', icon: '🧴', minDays: 0, type: 'yaz' },
  ...
  { id: 'p134', text: 'Şemsiye', category: 'Diğer', icon: '☂️', minDays: 0 },
...
export const BUCKET_LIST = [
  ...
  { id: 7, title: 'Santorini', country: 'Yunanistan', city: '', duration: '1.5s', flag: '🇬🇷', category: 'Romantik', budget: '€600–1.200', season: 'Mayıs–Eylül' },
  { id: 8, title: 'New York City', country: 'ABD', city: '', duration: '11s', flag: '🇺🇸', category: 'Şehir', budget: '€2.000–3.000', season: 'Eylül–Kasım' },
  { id: 9, title: 'Petra', country: 'Ürdün', city: '', duration: '2s', flag: '🇯🇴', category: 'Tarih', budget: '€700–1.200', season: 'Mart–Mayıs' },
  { id: 10, title: 'Taj Mahal', country: 'Hindistan', city: '', duration: '6.5s', flag: '🇮🇳', category: 'Tarih', budget: '€1.200–2.000', season: 'Ekim–Mart' },
  { id: 11, title: 'Great Wall of China', country: 'Çin', city: 'Pekin', duration: '9s', flag: '🇨🇳', category: 'Tarih', budget: '€1.500–2.500', season: 'Nisan–Mayıs' },
